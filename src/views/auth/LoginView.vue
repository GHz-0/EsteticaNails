    ...
    <div class="panel-left">
      <div class="salon-identity">
        ...
        <div class="salon-servicios">
          <span v-for="s in servicios" :key="s" class="servicio-chip">{{ s }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="panel-right">
      <div class="login-card" :class="{ loaded: cardCargada }">
        ...
        <form class="login-form" @submit.prevent="handleLogin">
          <!-- Email -->
          <div class="field-wrap" :class="{ focused: foco === 'email', filled: form.email }">
          ...
          <!-- Password -->
          <div class="field-wrap" :class="{ focused: foco === 'password', filled: form.password }">
...
import { getRutaDashboard } from '@/router/index'
...
const demoUsers = [
  { rol: 'usuario',  etiqueta: 'Cliente',       icono: '👤', email: 'usuario@demo.com',  password: '123456' },
  { rol: 'empleado', etiqueta: 'Empleada',       icono: '💇', email: 'empleado@demo.com', password: '123456' },
  { rol: 'admin',    etiqueta: 'Administrador',  icono: '🔑', email: 'admin@demo.com',    password: '123456' },
]

onMounted(() => {
  setTimeout(() => { cardCargada.value = true }, 100)
})
...
.servicio-chip:nth-child(1) { animation-delay: 0.1s; }
.servicio-chip:nth-child(2) { animation-delay: 0.2s; }
.servicio-chip:nth-child(3) { animation-delay: 0.3s; }
.servicio-chip:nth-child(4) { animation-delay: 0.4s; }
...
.demo-label { font-size: 0.7rem; font-weight: 500; }
...
.demo-usuario:hover { background: rgba(249,168,212,0.18); transform: translateY(-2px); }
...
.demo-empleado:hover { background: rgba(253,186,116,0.18); transform: translateY(-2px); }
...
.demo-admin:hover { background: rgba(196,181,253,0.18); transform: translateY(-2px); }
