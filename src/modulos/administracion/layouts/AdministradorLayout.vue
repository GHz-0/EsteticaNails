...
const navItems = [
  ...
  { name: "admin-reportes", titulo: "Reportes", iconoSvg: reportsIconSvg },
  { name: "admin-empleados", titulo: "Empleados", iconoSvg: employeesIconSvg },
  { name: "admin-servicios", titulo: "Servicios", iconoSvg: servicesIconSvg },
  { name: "admin-promociones", titulo: "Promociones", iconoSvg: promoIconSvg },
];
